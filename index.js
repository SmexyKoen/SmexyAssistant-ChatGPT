...
app.get('/gpt/:text', async (req, res) => {
    ...
    if (GPT_MODE === "CHAT"){
      ...
      if (response.data.choices) {
        ...
        if(agent_response.length > 480){
          console.log("Agent answer exceeds twitch chat limit. Slicing to first 480 characters.")
          agent_response = agent_response.substring(0, 480)
